  ...
  <div>
    ...
    <div class="inner-content">
      ...
      <p class="paragraph">
        ...
        resolusi efektif dan pertanggungjawaban atas kejahatan yang terus berlanjut. Meskipun ada harapan 
        normatif, tindakan konkret terhadap pelanggaran hak asasi manusia dan hukum humaniter internasional 
      ...
      <p class="paragraph">
        ...
        lingkungan dan mendeklarasikan penghentian konversi hutan. Gaya kepemimpinan SBY yang moderat dan 
        akomodatif, serta kepribadiannya yang lebih menyukai soft power, tercermin dalam pendekatannya 
        terhadap diplomasi lingkungan. Upaya SBY dalam menangani kabut asap menunjukkan komitmennya 
      ...
      <p class="paragraph">
        ...
        dan hashtag diplomacy menjadi instrumen penting dalam diplomasi modern. Pemanfaatan teknologi 
      ...
      <p class="paragraph">
        ...
        internasional. Ekspansi NATO ke Eropa Timur tidak cukup menjadi alasan untuk tindakan antisipasi 
        membela diri. Invasi ini juga melanggar kedaulatan Ukraina dan menyebabkan banyak korban jiwa yang 
        tidak bersalah. Tindakan Rusia ini merupakan pelanggaran terhadap hak asasi manusia dan hukum 
      ...
      <p class="paragraph">
        ...
        case study, the article underscores the severe repercussions of neglecting cybersecurity measures. 
        The discussion extends to the contemporary challenges introduced by the COVID-19-induced remote work 
        environment, emphasizing heightened cyber threats and the need for robust cybersecurity awareness. 
        Advocating for comprehensive training and awareness initiatives, the article calls for proactive 
        cybersecurity measures to empower individuals and organizations in navigating the ever-evolving 
